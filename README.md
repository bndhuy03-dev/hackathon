...
Minh — Backend, data and AI logic. Prompts, model calls, matching or recommendation logic, any dashboard data. This covers the Data Analyst slot the brief expects.
Khai — Business Analyst + comms lead (two roles). Problem statement, target user, evidence the problem matters, impact metrics, implementation plan, responsible-AI section, and the pitch. He should also write the acceptance criteria on each issue before the coders start, or you'll build features nobody asked for.
